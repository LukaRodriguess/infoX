...
Ter um banco de dados local baseado no MySQL 8 , no exemplo usei o XAMPP que pode ser obtido no link indicado.[download xampp](https://sourceforge.net/projects/xampp/)
